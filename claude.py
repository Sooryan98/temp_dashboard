...
st.set_page_config(page_title="Destro Dashboard", layout="wide", initial_sidebar_state="collapsed")
...
with col2:
    if st.button("🔧 Doors Analytics", key="door_btn", use_container_width=True):
...
if logo_base64 or yusen_base64:
    ...
    if logo_base64:
        header_content += f'<img src="data:image/png;base64,{logo_base64}" class="logo" alt="Destro Logo">'
    
    if yusen_base64:
        header_content += f'<img src="data:image/png;base64,{yusen_base64}" class="logo" alt="Yusen Logo">'
...
if st.session_state.current_page == 'Overview':
    ...
    st.markdown('<div class="section-header">Door Analytics Dashboard</div>', unsafe_allow_html=True)
    ...
    with col1:
        st.markdown(f"""
            <div class="metric-tile">
                <div class="metric-title">Inbound Doors</div>
    ...
    with col2:
        st.markdown(f"""
            <div class="metric-tile">
                <div class="metric-title">Outbound Doors</div>
    ...
    with col1:
        st.markdown('<div class="chart-container">', unsafe_allow_html=True)
        st.markdown('<div class="chart-title">Inbound Door Dwell Time</div>', unsafe_allow_html=True)
    ...
    with col2:
        st.markdown('<div class="chart-container">', unsafe_allow_html=True)
        st.markdown('<div class="chart-title">Outbound Door Dwell Time</div>', unsafe_allow_html=True)
