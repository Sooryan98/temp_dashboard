...
yusen_base64 = get_image_base64("NFI.png")
...
if logo_base64 or yusen_base64:
    ...
    if logo_base64:
         header_content += f'<img src="data:image/png;base64,{logo_base64}" class="logo" alt="Destro Logo" style="height: 35px; width: auto;">'
    header_content += '''
                <div class="time-info">
...
if st.session_state.current_page == 'Overview':
    ...
    with col1:
        ...
        st.markdown(f"""
            <div class="metric-tile">
                <div class="metric-title">Pallets Per Hour</div>
                <div class="metric-value">{int(uph_value/pallet_conversion)}</div>
    ...
    with col2:
        st.markdown(f"""
            <div class="metric-tile">
                <div class="metric-title">Total Pallets</div>
                <div class="metric-value">{int(code_101/pallet_conversion)}</div>
    ...
    with col1:
        ...
        st.markdown('<div class="chart-title">PPH Progression</div>', unsafe_allow_html=True)
