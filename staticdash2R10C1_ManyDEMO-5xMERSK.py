...
DESTRO_PATH = "log_bank/1_Many/DEMO-5x/10C/Fixed Run/yusen_2025-07-13.log"
FMS_PATH = "log_bank/1_Many/DEMO-5x/10C/Fixed Run/FMS_2025-07-13.log"
...
end_time='2025-07-13 16:41:10,000000'
...
yusen_base64 = get_image_base64("maersk_logo.png")
...
if logo_base64 or yusen_base64:
    ...
    if yusen_base64:
        header_content += f'<img src="data:image/png;base64,{yusen_base64}" class="logo" alt="Yusen Logo" style="height: 60px; width: auto;">'
    if logo_base64:
